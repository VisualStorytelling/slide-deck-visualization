...
import { ProvenanceSlidedeck, ProvenanceSlidePlayer } from "../src/provenance-slide-deck";
import { ProvenanceSlide } from "../src/provenance-slide";
import { STATUS } from "../src/provenance-slide-player";
...
describe('ProvenanceTreeSlidedeck', () => {
  beforeEach(() => {
    ...
    player = new ProvenanceSlidePlayer(slideDeck.slides as ProvenanceSlide[], (slide) => { slideDeck.selectedSlide = slide; });
  });
